...
let ProvidersController = class ProvidersController {
    ...
    async getProviders() {
        return await this.userRepository.find({ where: { role: user_entity_1.UserRole.PROVIDER } });
    }
};
exports.ProvidersController = ProvidersController;
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'List of all service providers' }),
